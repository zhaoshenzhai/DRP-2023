...
\begin{document}
    ...
    \end{definition}
    \begin{example}\side[-0.15in]{Every Riemann surface can be regarded as a (connected) $2$-dimensional real manifold by $\textrm{`}$forgetting$\textrm{'}$ its complex structure.}
