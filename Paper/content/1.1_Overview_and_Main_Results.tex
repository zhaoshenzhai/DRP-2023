    ...
    \begin{center}
        \begin{tikzpicture}[scale=1.2]
            ...
            \begin{scope}[rotate=30, xshift=-0.7cm, yshift=-0.15cm]
                ...
                \draw[dash pattern={on 2pt off 2pt}] (0,0) ellipse (0.3 and 0.2);
            \end{scope}
            \begin{scope}[xshift=-1.9cm, yshift=-2cm]
                ...
                \begin{scope}[rotate=-5]
                    \draw[dash pattern={on 2pt off 3pt}] (0.4,0.45) ellipse (0.2 and 0.25);
                \end{scope}
            \end{scope}
            \begin{scope}[xshift=-0.25cm, yshift=-2cm]
                ...
                \begin{scope}[rotate=-20]
                    \draw[dash pattern={on 2pt off 3pt}] (0.26,0.55) ellipse (0.2 and 0.25);
                \end{scope}
            \end{scope}
