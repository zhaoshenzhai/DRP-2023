    ...
    \begin{proof}
        ...
        Suppose now that the lifting $\l.\tilde{\alpha}\r|_{\l[0,t_{k-1}\r]}:\l[0,t_{k-1}\r]\to E$ has been constructed for some $k\geq1$. Then\side{
            \begin{equation*}
                ...
                \end{tikzcd}
            \end{equation*}
        } $\alpha\l(t_{k-1}\r)=\pi\l(\tilde{\alpha}\l(t_{k-1}\r)\r)\in U_k$, so there exists some $j\in J_k$ such that $\tilde{\alpha}\l(t_{k-1}\r)\in V_{kj}$. Letting $\cchi\to V_{kj}$ be the inverse of $\l.\pi\r|_{V_{kj}}:V_{kj}\to U_k$, we set
        \begin{equation*}
