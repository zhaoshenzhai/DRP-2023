...
\begin{document}
    ...
    \end{lemma}\side[-0.15in]{Intuitively, scaling and rotating the lattice, which are biholomorphisms of the plane, should preserve the complex structure on the torus. Thus only one complex parameter is needed to generate the torus, which we choose to be the ratio $\tau\coloneqq\omega_2/\omega_1$.}\vspace{-0.08in}
    \begin{proof}
