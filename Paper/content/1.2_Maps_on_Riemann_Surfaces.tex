...
\begin{document}
    ...
    \begin{definition}\label{1.2:def:order}
        ...
        \end{equation*}
    \end{definition}
    \side[-0.53in]{Note that $f$, being meromorphic, ensures that its Laurent series has finitely-many negative terms, so the definition makes sense. If $f$ is not meromorphic, we take $\ord_p\!\l(f\r)\coloneqq\infty$.\\\ \\
