...
\begin{document}\frame{\titlepage}
    ...
    \begin{frame}{Surfaces}
        Recall that a surface is a connected $2$-dimensional real manifold.

        \begin{center}
            \includegraphics[width=0.7\textwidth]{figures/manifolds.png}
        \end{center}

        \pause\vspace{-0.3in}

        \begin{definition}
            \textit{A \ul{Riemann surface} is a surface with a choice of complex structure.}
        \end{definition}
    \end{frame}
        ...
        \begin{proof}
            ...
            \begin{itemize}
                ...
                \item[\scriptsize$\blob$] \scriptsize Analytic continuation: We attempted to find such a meromorphic function, but our techniques weren't powerful enough.
                    \pause
                \item[\scriptsize$\blob$] \scriptsize Sheaf cohomology: uhh something.\qed
            \end{itemize}
        \end{proof}
    \end{frame}
