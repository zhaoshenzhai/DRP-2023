...
\title{\normalsize{Possible Choices of Complex Structures for a Surface}}
...
\begin{document}\frame{\titlepage}
    \begin{frame}{Complex structures on $\R^2$}
        \begin{center}
            \begin{tikzpicture}
                \draw[<->, thick] (-2,0) -- (2,0);
    ...
    \begin{frame}{Refined question}
        \begin{center}
            How many complex structures on $\R^2$?
        \end{center}
    \end{frame}
    \begin{frame}{Refined question}
        \begin{center}
            \sout{How many complex structures on $\R^2$?}\\
            How many complex structures on $\R^2$ \textit{up to biholomorphism}?
        \end{center}
    \end{frame}
    \begin{frame}{$\C$ and $\H$}
        \begin{center}
    ...
    \begin{frame}{Riemann surfaces}
        \begin{definition}
            \textit{A \ul{Riemann surface} is a surface equipped with a complex structure.}
        \end{definition}
        \begin{center}
