...
\begin{document}
    ...
    \begin{definition}
        ...
        \end{equation*}
    \end{definition}
    \side[-0.53in]{Note that $f$, being meromorphic, ensures that its Laurent series has finitely-many negative terms. Thus the set $\l\{n\in\Z\mid c_n\neq0\r\}$ achieves its minimum, so the definition makes sense. Of course, it still remains to show that $\ord_p\!\l(f\r)$ is independent of the local coordinate defining the Laurent series.}\vspace{-0.1in}
    \begin{proof}
