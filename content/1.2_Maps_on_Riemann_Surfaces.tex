...
\begin{document}
    ...
    \begin{example}[Biholomorphisms between Riemann spheres]
        Let $\C_\infty$, $S^2$, and $\P^1$ denote the three constructions for the Riemann sphere $\RS$ presented in Examples \ref{1.1:one_point_compactification_of_C}, \ref{1.1:stereographic_projection}, and \ref{1.1:complex_projective_line}, respectively. We shall show that the maps\side[0.28in]{Take $G\l(0,0,1\r)\coloneqq\infty$.}
        \begin{equation*}
