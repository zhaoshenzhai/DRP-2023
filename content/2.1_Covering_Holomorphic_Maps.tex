...
\begin{document}
    ...
    This section develops some technical tools to define the \textit{number of sheets} of a covering, which is then used to define the \textit{degree} of a proper holomorphic map.
    \begin{definition}
