...
\begin{document}
    ...
    \begin{proof}
        ...
        \end{equation*}
        Clearly\side{$\tilde{\alpha}\l(t_{k-1}\r)=\phi\l(\alpha\l(t_{k-1}\r)\r)=\phi\l(\pi\l(\tilde{\alpha}\l(t_{k-1}\r)\r)\r)$ on the appropriate restrictions.}, $\tilde{\alpha}\!\l(t_{k-1}\r)$ agrees with our existing lifting, which makes the piecewise-defined map $\l.\alpha\r|_{\l[0,t_k\r]}$ a lifting of $\l.\alpha\r|_{\l[0,t_k\r]}$ w.r.t. $\pi$.\qed
    \end{proof}
