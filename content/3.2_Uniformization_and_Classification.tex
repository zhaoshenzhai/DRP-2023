...
\begin{document}
    ...
    \end{theorem}
    \begin{proofsketch}\side[0.1in]{This sketch follows \cite{peter}.}
        As in Theorem \ref{3.1:thm:simply-connect_compact_biholomorphic_Riemann_sphere}, fix $p\in X$ and let $f\in\HOLO\l[p\r]\l(X\r)$ be meromorphic with a single simple pole. Let $F:X\to\RS$ be its associated holomorphic map, so $F\l(p\r)=\infty$. Since $\deg F=1$, we see that $\mult_p\!\l(F\r)=1$ and so $\l.F\r|_U:U\to V$ is a biholomorphism for some neighborhoods $U\subseteq X$ of $p$ and $V\subseteq\RS$ of $\infty$. We outline the rest of the proof.\side[0.23in]{These claims are nontrivial and is beyond the scope of this paper.}
        \begin{itemize}
