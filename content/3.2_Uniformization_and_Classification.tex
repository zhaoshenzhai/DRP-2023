...
\begin{document}
    ...
    \end{theorem}
    \begin{proofsketch}\side{This sketch follows \cite{peter}.}
        As in Theorem \ref{3.1:thm:simply-connect_compact_biholomorphic_Riemann_sphere}, fix $p\in X$ and let $f\in\HOLO\l[p\r]\l(X\r)$ be meromorphic with a single simple pole. Let $F:X\to\RS$ be its associated holomorphic map, so $F\l(p\r)=\infty$. Since $\deg F=1$, we see that $\mult_p\!\l(F\r)=1$ and so $\l.F\r|_U:U\to V$ is a biholomorphism for some neighborhoods $U\subseteq X$ of $p$ and $V\subseteq\RS$ of $\infty$. We outline the rest of the proof.\side{These claims are highly-nontrivial and is beyond the scope of this paper.}
        \begin{itemize}
            ...
            \item It can also be shown that $\im F$ is open, contains the `top and bottom halves' of\side{That is, $\l\{x\in X\mid\Im\phi\l(z\r)\neq0\r\}\subseteq\im F$.} $\RS$, and is a biholomorphism onto its image.
        \end{itemize}
