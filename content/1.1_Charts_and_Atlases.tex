...
\begin{document}
    ...
    \begin{example}[Complex Projective Line]\label{1.1:complex_projective_line}
        ...
        \begin{equation*}
            \begin{alignedat}{2}
                U_1&\coloneqq\RS\comp\l\{\proje{0:w}\mid w\in\C\r\}\ \ \ \ \ \ \ \ \ \ \ \ &&\phi_1:U_1\to\C:\proje{z:w}\mapsto w/z \\
                U_2&\coloneqq\RS\comp\l\{\proje{z:0}\mid z\in\C\r\}&&\phi_2:U_2\to\C:\proje{z:w}\mapsto z/w.
            \end{alignedat}
        \end{equation*}
