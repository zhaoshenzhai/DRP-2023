...
\begin{document}
    ...
    \begin{example}
        ...
        \begin{itemize}
            ...
            \item If $f,g:W\to\C$ are both holomorphic at some $p\in W$, then\side{This makes the set $\ms{O}\l(W\r)$ of all holomorphic maps $f:W\to\C$ into a $\C$-algebra.} so are $f\pm g$ and $f\cdot g$. If $g\l(p\r)\neq0$, then so is $f/g$.\exqed
        \end{itemize}
    \end{example}
    \begin{definition}
