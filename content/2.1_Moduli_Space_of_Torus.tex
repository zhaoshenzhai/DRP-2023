...
\begin{document}
    ...
    \end{lemma}\side[-0.17in]{This reduces the analysis to just tori of the form $X_\tau$, which allows us to leverage Lemma \ref{2.1:lem:moduli_space_torus_3}.}\vspace{-0.08in}
    \begin{proof}
    ...
    \end{proof}
    \begin{lemma}\label{2.1:lem:moduli_space_torus_3}
    ...
    \begin{proof}
        ...
        \begin{equation*}
            ...
            \end{tikzcd}           
        \end{equation*}
        commutes. Then $\tilde{\phi}$ is a meromorphic function on the Riemann sphere with a pole at $\infty$, so, by Theorem \ref{1.2:thm:meromorphic_Riemann_sphere_rational}, $\tilde{\phi}$ is a rational function. Noting that $\tilde{\phi}$ is defined on all of $\C$, we see that $\tilde{\phi}$ must be a polynomial. If $\deg\tilde{\phi}>1$, then, by the Fundamental Theorem of Algebra, the equation $\tilde{\phi}\l(z\r)=0$ has more than one solution, contradicting the fact that $\tilde{\phi}$ is a bijection.
    \end{proof}
    \begin{theorem}
